...
while True:
    ...
    if question.lower() in ["exit", "quit", "stop", "goodbye"]:
        print("Exiting voice chat...")
        break
    
    # Process if we got a question
    if question:
        try:
            ...
            error_message = "Sorry, I encountered an error processing your question. Please try again."
            print(error_message)
            play_audio_response(error_message)
